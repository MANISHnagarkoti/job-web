        ...
        <div className=' mt-[100px] container '>
            <div className='relative'>
                ...
                <div className='w-full h-full absolute top-0 left-0 right-0 py-4 flex flex-col justify-center items-center bg-black/10'>
                    ...
                    <div className='text-5xl font-semibold text-white text-center'>Make a difference with your skills</div>
                ...
                <img src="homeimg/sectionFoutbg.png" className="w-full" alt="" />
            </div>
